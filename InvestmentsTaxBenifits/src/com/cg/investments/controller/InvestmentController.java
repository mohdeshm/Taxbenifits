...
public class InvestmentController {
	...
	public String storeSalaryDetails(Model model, @ModelAttribute("employeeSalary") EmployeeSalary employeeSalary) {
		...
		long totalSalary = employeeSalary.getBasic() + employeeSalary.getCapgeminiContributionPF()
				+ employeeSalary.getConveyanceAllowance() + employeeSalary.getGratuity()
				+ employeeSalary.getHouseRentAllowance() + employeeSalary.getMedicalAccidentLifeInsurancePremium()
				+ employeeSalary.getOtherReimbursementAllowance() + employeeSalary.getPersonalAllowance()
				+ employeeSalary.getStatutoryBonus();
	...
	public String login(Model model,
			@ModelAttribute("taxBenifitInvestments") TaxBenifitInvestments taxBenifitInvestments) {
