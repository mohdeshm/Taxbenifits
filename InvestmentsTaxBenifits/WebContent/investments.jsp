...
<body>
			...
			<table bgcolor="#E4E47C" align="left" border="1">
				...
				<tr>
					...
					<td><form:input path="basic" type="number" required="required"
							maxlength="8"></form:input> <form:errors path="basic"></form:errors></td>
				</tr>
				<tr>
	...
	<form name="savingtotal" action="index.htm" method="post">
			<table bgcolor="#E4E47C" align="right" border="1">				
				<tr><td><input value="${savings}" readonly></input></td></tr>
